...
class LoginSimple3 extends StatefulWidget {
  const LoginSimple3({super.key});

  @override
  State<LoginSimple3> createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginSimple3> {
  late Color myColor;
  late Size mediaSize;
